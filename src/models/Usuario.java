...
public class Usuario {
	...
	public static Usuario getInstance()
	{
		if(instance == null)
		{
			JOptionPane.showMessageDialog(null, "Usuario não passou pela Autentificação!", "Erro", JOptionPane.ERROR_MESSAGE);
			System.exit(0);
		}
		return instance;
	}
	...
	public byte[] Decriptar_File(String path, String name)
	{
		...
		try 
		{
			...
			Signature sig = LoginNameAuthenticator.getInstance().Gerar_AssinaturaDigital("SHA1withRSA");
